              ...
              <CardBody>
                ...
                <Col md={6}>
                  ...
                  <Container className="text-center m-0 p-0">
                    <p className="btn" style={{width:'90px', backgroundColor:'#146ca4', color:'white'}}>Register</p>
                    <p onClick={resetData} className="ms-5 btn" type="reset" style={{width:'90px', backgroundColor:'#146ca4', color:'white'}}>
                      Reset
                    </p>
                    <p>
                      Already have an account?
                      <Link to="/dsignin">Click here</Link>
                    </p>
                  </Container>
                </Form>
              </CardBody>
